...
% ===== 提交前只需改这一行 =====
\newcommand{\repourl}{https://github.com/YOUR-ACCOUNT/rlvr-control-group-audit}
...
\input{sec/06_scale}
\input{sec/07_analysis}
\input{sec/08_statistics}
\input{sec/09_discussion}
...
\input{app/C_pot}
\input{app/D_hacking}
\input{app/E_stability}
\input{app/F_reproduce}
\input{app/G_followup}
